...
{
    public class CustomErrorDecriber :IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"{userName} kullanıcı adı daha önce sisteme kayıt edilmiştir. Başka bir kullanıcı adı oluşturunuz!"
            };
        }
        public override IdentityError DuplicateEmail(string email)
        {
            ...
            {
                Code = "DuplicateEmail",
                Description = $"{email} email hesabı daha önce sisteme kayıt edilmiştir. Başka bir email hesabı ile kayıt oluşturunuz!"
            };
        }
    }
}
